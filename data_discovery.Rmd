...
We have removed the 200 rows where the population of `NA`s were 75%, reducing our overall dataset from __`r nrow(churn_df)`__ to __`r nrow(churn_df_1)`__.

Now that we have removed rows which had very little information in them, we can focus on figuring out a strategy on filling in the missing values of our remaning rows.
