...
modelRF1 <- glm(
  churn~international_plan+
    voice_mail_plan+
    total_day_charge+total_eve_charge+total_intl_calls+number_customer_service_calls+total_night_minutes+total_intl_charge+state,
  data=train_df_rf,
  family="binomial")
...
```{r}
pred_churn_rf1 <- predict(modelRF1, newdata = test_df_rf, type = "response")
roc_out_rf1 <- roc(test_df_rf$churn, pred_churn_rf1)
roc_out_rf1
```
