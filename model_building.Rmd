...
Judging from our prediction churn status findings and our actual churn status findings, we found out our misclassification rate to be: 
(186+81)/1547 errors - 1.73% misclassification rate, relatively low rate.
